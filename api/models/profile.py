...
class Profile(models.Model):
    ...
    external_id = models.IntegerField("Код сотрудника", validators=[RegexValidator(r'^\d{6}$')],
    ...
    test_balance = models.DecimalField("Тестовый баланс", max_digits=8, decimal_places=2,
                                       default=0.00)
